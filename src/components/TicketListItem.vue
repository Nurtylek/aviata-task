<template>
  ...
  >
      ...
      <div class="flex space-between">
        <div>
          <img
            ...
            loading="lazy"
          />
          <span class="ticket__carrier-name marginLeft-12">{{
            ticket.carrier_name
          }}</span>
        </div>
        ...
        <div>
          <div class="ticket__diff text-center">
            {{ diffTime(ticket.flights.duration) }}
          </div>
          <!--                        <div>-->
    ...
    <div class="ticket__cta flex flex-column space-between">
      <span class="ticket__price marginBottom-12"
        >{{ ticket.price.amount }} ₸</span
      >
    ...
    <teleport to="#portals">
      <div v-if="isOpen">
        ...
        <div class="modal">
          <p>
            Just to demonstrate new feature of vue 3 (teleporting elements as a
            direct child of body element (in this case)
          </p>
        </div>
      </div>
    </teleport>
